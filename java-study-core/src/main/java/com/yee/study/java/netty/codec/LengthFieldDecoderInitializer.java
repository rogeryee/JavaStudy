...
/**
 * 基于LengthFieldBasedFrameDecoder的通道初始化类
 * <p>
 ...
 * @author Roger.Yi
 */
public class LengthFieldDecoderInitializer extends ChannelInitializer<SocketChannel>
{
    /**
     * 解码的帧的最大长度
     */
    ...
    /**
     * 长度属性的起始位（偏移位），包中存放有整个大数据包长度的字节，这段字节的其实位置
     */
    ...
    public LengthFieldDecoderInitializer(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip)
    {
