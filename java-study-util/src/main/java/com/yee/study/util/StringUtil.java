...
public class StringUtil
{
     ...
     * @return
     */
    private static String doJoin(Collection<?> col, String separator, boolean joinElements, boolean ignoreNullElement, Collection<Object> context)
    {
        if (col == null)
        {
            return null;
     ...
     * @return
     */
    private static String doJoin(Object[] objs, String separator, boolean joinElements, boolean ignoreNullElement, Collection<Object> context)
    {
        if (objs == null)
        {
            return null;
