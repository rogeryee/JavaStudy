...
public final class BeanUtil
{
     ...
     * @param ignoredProps
     * @return
     * @see com.yee.study.util.BeanUtil.CopyPropModes
     */
                ...
                switch (mode)
                {
                    ...
                    case CopyPropModes.TARGET_VALUE_NOT_SET:
                        ...
                        if (targetReadMethod != null)
                        {
                            ...
                            doSet = (targetValue == null || targetValue.equals(ObjectUtil.defaultValue(targetPropDesc.getPropertyType())));
                        }
                        break;
                }
            ...
            try
            {
                ...
                switch (mode)
                {
                    ...
                    case CopyPropModes.TARGET_VALUE_NOT_SET:
                        ...
                        {
                            Object targetValue = targetReadMethod.invoke(target);
                            doSet = (targetValue == null || targetValue.equals(ObjectUtil.defaultValue(propDesc.getPropertyType())));
                        }
     ...
     * @param obj1
     * @param obj2
     * @param propNamesToCompare 为null或空数组，则比较两对象同名属性；如果指定属性名在两个对象的任意一个中不存在，则被忽略
     * @return
     */
    ...
    {
        WeakReference<Map<String, PropertyDescriptor>> propDescRef = (WeakReference<Map<String, PropertyDescriptor>>) classCache.get(clazz);
